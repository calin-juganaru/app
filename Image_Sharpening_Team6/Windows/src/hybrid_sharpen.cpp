...
inline static auto sharpen_local(image_t& image, int omp_threads)
{
    auto N = image.size();
...
inline static auto partial_sharpen(int omp_threads, int std_threads, int thread_id,
...
exec_time_t hybrid_sharpen(int THREADS, string input_file, string output_file)
{
    auto start = chrono::high_resolution_clock::now();

    auto std_threads = THREADS;
