...
using exec_time_t = long double;

exec_time_t serial_sharpen(string, string);
exec_time_t thread_sharpen(int, string, string);
exec_time_t openmp_sharpen(int, string, string);
exec_time_t hybrid_sharpen(int, string, string);
